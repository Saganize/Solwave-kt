...
-keepclassmembers class com.saganize.solwave.data.remote.model.NetworkResponse { !transient <fields>; }
-keepclassmembers class com.saganize.solwave.data.remote.model.** { !transient <fields>; }
